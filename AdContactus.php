...
if (isset($_SESSION['id']) && isset($_SESSION['fname'])) {
  ?>
  <?php include "php/AdContactus.php"; ?>
  <!DOCTYPE html>
  <html>
      ...
      <div class="offcanvas-body">
        <nav class="sidebar-nav">
          <div class="list-group">
            ...
            <a href="AdContactus.php" class="list-group-item list-group-item-action active">Contact Us</a>
            ...
            <tbody>
              ...
              while ($rows = mysqli_fetch_assoc($result)) {
                ...
                <tr>
                  ...
                  <td>
                    <?php echo $rows['c_email']; ?>
                  </td>
                  <td>
                    <?php echo $rows['c_message']; ?>
                  </td>
                  <td>

                    <a href="php/delete_contact.php?id=<?= $rows['id'] ?>" class="btn btn-primary">Delete</a>
                  </td>
                </tr>
              <?php } ?>
            </tbody>
