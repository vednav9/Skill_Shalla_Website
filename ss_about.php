      ...
      <ul class="row">
        <li class="col-12 col-md-6 col-lg-3">
          <div class="cnt-block equal-hight" style="height: 349px;">
            <figure><img src="images/Kpic.jpg" class="img-responsive" alt=""></figure>
            <h3><a href="#">Krishna Bhattu</a></h3>
            <p>Final Year Diploma,Computer Enginneering, Mumbai</p>
            <ul class="foot">
              <a href="#" style="margin-right:1rem"><i class="fa-brands fa-instagram"></i></a>
              <a href="#" style="margin-right:1rem"><i class="fa-brands fa-linkedin"></i></a>
              <a href="#" style="margin-right:1rem"><i class="fa-brands fa-square-facebook"></i></a>
            </ul>
          </div>
        </li>
        <li class="col-12 col-md-6 col-lg-3">
          <div class="cnt-block equal-hight" style="height: 349px;">
            <figure><img src="images/pic1.jpg" class="img-responsive" alt=""></figure>
            <h3><a href="#">Kartikey Chapte</a></h3>
            <p>Final Year Diploma,Computer Enginneering, Mumbai</p>
            <ul class="foot">
              <a href="#" style="margin-right:1rem"><i class="fa-brands fa-instagram"></i></a>
              <a href="#" style="margin-right:1rem"><i class="fa-brands fa-linkedin"></i></a>
        ...
        <li class="col-12 col-md-6 col-lg-3">
          <div class="cnt-block equal-hight" style="height: 349px;">
            <figure><img src="images/Spic.jpg" class="img-responsive" alt=""></figure>
            <h3><a href="#">Shardul Brid</a></h3>
            <p>Final Year Diploma,Computer Enginneering, Mumbai</p>
            <ul class="foot">
              <a href="#" style="margin-right:1rem"><i class="fa-brands fa-instagram"></i></a>
              <a href="#" style="margin-right:1rem"><i class="fa-brands fa-linkedin"></i></a>
