      ...
      <div class="container-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav m-auto mb-2 mb-lg-0 action">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="ss_about.php">About Us</a>
            </li>
            <li class="nav-item">
    ...
    <div class="content">
      <div class="left-side">
        <div class="address details">
          ...
          <div class="text-one">CO Dept, Thakur Poytechinc</div>
          <div class="text-two">Kandivali (E), Mumbai</div>
        </div>
      ...
      <div class="right-side">
        ...
        <p>If you have any work from me or any types of quries related to my tutorial, you can send me message from
          ...
          <form action="php/ss_contact.php" method="post">
          <?php
            if(isset($error))
            {
